...
s:tab("serverconfig", translate("Server Config File"))
local server_conf = "/etc/config/openvpn" 
local NXFS = require "nixio.fs"
o = s:taboption("serverconfig", TextValue, "server_conf")
o.description = translate("Directly edit the OpenVPN server configuration file. Warning: incorrect configuration may cause the service to fail.")
o.rows = 13
o.wrap = "off"
o.cfgvalue = function(self, section)
	return NXFS.readfile(server_conf) or ""
end
o.write = function(self, section, value)
	NXFS.writefile(server_conf, value:gsub("\r\n", "\n"))
end
